...
func TestIsNotRoutedWithAddressXFFHeaders(t *testing.T) {
	xff := []struct {
		...
		{"172.16.255.255, 10.4.0.0.1, 192.1.4.1, 202.0.0.4, 10.1.1.1", "192.1.4.1"},
		{"192.168.1.100,  172.16.1.4, 54.0.1.53, 10.1.4.3, 192.168.1.1", "54.0.1.53"},
		{"l27.0.0.2", ""},
		{"169.123.23.3, 2001:0db8:85a3:0000:0000:8a2e:0370:7334, 192.168.1.1", "169.123.23.3"},
		{"::", ""},
		{"", ""},
		{"fd00::, 2001:0db8:85a3:0000:0000:8a2e:0370:7334, 192.4.1.56", "2001:db8:85a3::8a2e:370:7334"},
		{"202.0.0.4,100.124.109.128", "202.0.0.4"},
		{"202.0.0.4,100.64.0.0", "202.0.0.4"},
		{"202.0.0.4,100.127.255.255", "202.0.0.4"},
	}
	for i := range xff {
